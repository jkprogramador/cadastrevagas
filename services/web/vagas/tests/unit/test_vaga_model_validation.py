...
class VagaModelValidationTest(SimpleTestCase):
    ...
    def test_empresa_nome_cannot_be_blank(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx:
            vaga.full_clean(exclude=self.all_fields - {'empresa_nome'})
    ...
    def test_empresa_endereco_can_be_blank(self) -> None:
        ...
        vaga.full_clean(exclude=self.all_fields - {'empresa_endereco'})
    ...
    def test_empresa_email_can_be_blank(self) -> None:
        ...
        vaga.full_clean(exclude=self.all_fields - {'empresa_email'})
    ...
    def test_empresa_site_cannot_be_blank(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx:
            vaga.full_clean(exclude=self.all_fields - {'empresa_site'})
    ...
    def test_empresa_telefone_celular_can_be_blank(self) -> None:
        ...
        vaga.full_clean(exclude=self.all_fields - {'empresa_telefone_celular'})
    ...
    def test_empresa_telefone_celular_must_be_valid_cellphone(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx1:
            vaga1.full_clean(exclude=self.all_fields - {'empresa_telefone_celular'})
        ...
        with self.assertRaises(ValidationError) as ctx2:
            vaga2.full_clean(exclude=self.all_fields - {'empresa_telefone_celular'})
        ...
        vaga3.full_clean(exclude=self.all_fields - {'empresa_telefone_celular'})
    ...
    def test_empresa_telefone_comercial_can_be_blank(self) -> None:
        ...
        vaga.full_clean(exclude=self.all_fields - {'empresa_telefone_comercial'})
    ...
    def test_empresa_telefone_comercial_must_be_valid_landline(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx1:
            vaga1.full_clean(exclude=self.all_fields - {'empresa_telefone_comercial'})
        ...
        with self.assertRaises(ValidationError) as ctx2:
            vaga2.full_clean(exclude=self.all_fields - {'empresa_telefone_comercial'})
        ...
        vaga3.full_clean(exclude=self.all_fields - {'empresa_telefone_comercial'})
    ...
    def test_cargo_titulo_cannot_be_blank(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx:
            vaga.full_clean(exclude=self.all_fields - {'cargo_titulo'})
    ...
    def test_cargo_descricao_can_be_blank(self) -> None:
        ...
        vaga.full_clean(exclude=self.all_fields - {'cargo_descricao'})
    ...
    def test_site_referencia_cannot_be_blank(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx:
            vaga.full_clean(exclude=self.all_fields - {'site_referencia'})
    ...
    def test_site_referencia_must_be_valid_url(self) -> None:
        ...
        with self.assertRaises(ValidationError) as ctx:
            vaga1.full_clean(exclude=self.all_fields - {'site_referencia'})
        ...
        vaga2.full_clean(exclude=self.all_fields - {'site_referencia'})
    ...
    def test_data_hora_entrevista_must_be_valid_datetime(self) -> None:
        ...
        vaga2.full_clean(exclude=self.all_fields - {'data_hora_entrevista'})
